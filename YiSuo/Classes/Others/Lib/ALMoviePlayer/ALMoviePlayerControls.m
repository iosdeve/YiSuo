...
- (void)setup {
    ...
    [_durationSlider setThumbImage:[UIImage imageNamed:@"player-progress-point"] forState:UIControlStateNormal];
    [_durationSlider setThumbImage:[UIImage imageNamed:@"player-progress-point-h"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews {
    ...
    CGFloat sliderHeight = 10.f; //default height
    ...
    CGFloat playWidth = 10.f;
    CGFloat playHeight = 10.f;
    ...
    if (self.style == ALMoviePlayerControlsStyleFullscreen || (self.style == ALMoviePlayerControlsStyleDefault && self.moviePlayer.isFullscreen)) {
        ...
        //chenxin mark x多加了4
        self.timeElapsedLabel.frame = CGRectMake(self.playPauseButton.frame.origin.x + self.playPauseButton.frame.size.width + 4, 0, labelWidth, self.barHeight);
